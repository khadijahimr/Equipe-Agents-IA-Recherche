...
khad_reddit_researcher = Agent(
    name="Khad's Reddit Researcher",
...
khad_hackernews_researcher = Agent(
    name="Khad's HackerNews Researcher",
...
khad_academic_paper_researcher = Agent(
    name="Khad's Academic Paper Researcher",
    model=OpenAIChat("gpt-4o"),
...
khad_twitter_researcher = Agent(
    name="Khad's Twitter Researcher",
    model=OpenAIChat("gpt-4o"),
...
agent_team = Team(
    ...
    members=[
        ...
        khad_reddit_researcher,
        khad_hackernews_researcher,
        khad_academic_paper_researcher,
        khad_twitter_researcher,
    ],
    instructions=[
...
if __name__ == "__main__":
    asyncio.run(
        agent_team.aprint_response(
            ...
            message="Start the discussion on the topic: 'The impact of AI in medical diagnostics'",
            stream=True,
